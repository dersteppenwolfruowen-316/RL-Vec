...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-floorplan_3b_grpo_$(date +%Y%m%d_%H%M%S)}
...
echo "[3/3] Launching GRPO training (3B, single-node, 4 GPUs) ..."
python -m verl.trainer.main \
    config=config/easyr1/qwen2_5_vl_3b_grpo.yaml \
